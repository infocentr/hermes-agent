...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    # Discord voice extras are intentionally excluded until discord.py permits
    # fixed PyNaCl; pulling `discord.py[voice]` drags vulnerable PyNaCl<1.6.
    "platform.discord": ("discord.py==2.7.1", "brotlicffi==1.2.0.1"),
    "platform.slack": (
        "slack-bolt==1.27.0",
        "slack-sdk==3.40.1",
        "aiohttp==3.14.1",  # CVE-2026 aiohttp advisories patched by 3.14.1
    ),
    "platform.matrix": (
